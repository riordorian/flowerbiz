 ...
 */
class GoodWritesOffController extends Controller
{
    /**
     * @var string
     */
    protected $viewPath = '/admin/good-writes-off/';
    ...
    public function actionIndex()
    {
        ...
        $arQuery = array_merge(Yii::$app->request->queryParams, ['GoodSupplySearch' => ['WRITE_OFF' => true]]);
        $dataProvider = $searchModel->search($arQuery);
    ...
    public function actionUpdate($id)
    {
        ...
        elseif( $modelGoodsSupplies->load(Yii::$app->request->post() )){
            ...
            $modelGoodsSupplies->addGood($arNewProps['GOOD_SUPPLY_ID'], $arNewProps['GOOD_ID'], $arNewProps['AMOUNT'] * -1);
        }
            ...
            return $this->render($this->viewPath . 'update', [
                ...
                'arGoods' => CatalogProducts::getFilterValues(['>', 'AMOUNT', 0]),
