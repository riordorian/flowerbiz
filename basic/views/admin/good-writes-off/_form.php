...
<div class="good-supply-form row js-replaceable-container js-reload-elems">
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="active">
                <a data-toggle="tab" href="#tab-1">Информация о списании</a>
            </li>
            <li>
        ...
        <div class="tab-content">
            ...
            <div id="tab-1" class="tab-pane active">
                <div class="panel-body">
                    ...
                    <?=$form
                        ->field($model, 'DATE', ['options' => ['class' => 'col-md-6']])
                        ->textInput(['class' => 'form-control js-widget datetimepicker', 'value' => $model->isNewRecord ? date('d.m.Y H:i') : $model->DATE])
                        ->label('Дата списания')
                    ?>

                    <?=$form->field($model, 'WRITE_OFF')->hiddenInput(['value' => true])->label(false)?>
